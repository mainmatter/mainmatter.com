...
function prepareTemplates() {
  let templates = {
    'post-component-template': ['post', 'template.hbs'],
    'post-component-css-block': ['post', 'stylesheet.hbs'],
    'start-page-component-template': ['start-page', 'template.hbs'],
    'start-page-component-css-block': ['start-page', 'stylesheet.hbs'],
  };
