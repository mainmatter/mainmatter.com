...
const renderer = {
  ...
  html(html) {
    ...
    html = html.replace(/<blockquote(.*)blockquote>/gm, '<blockquote blog-post:class="quote"$1blockquote></div>');
    html = html.replace(/<author(.*)author>/gm, '<author blog-post:class="quote-author" typography:class="small"$1author></div>');
