...
![Bringing the Matrix Protocol to Elixir](/assets/images/posts/2020-10-26-bringing-matrix-to-elixir/illustration.svg#full)
...
I started it as a seperate project as it could conceivably be used in non-Matrix
based applications. The library is implemented using C NIFs and currently lacks
