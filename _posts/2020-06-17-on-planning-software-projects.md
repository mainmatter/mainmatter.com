---
title:
  "On planning software projects – or: why an iterative process doesn't
...
technical work – as that work happens anyway though, not representing it as
...
would all have to collaborate – from product experts to engineering and design
...
instead. In fact, we see the project manager role – at least in its classic
shape as someone directing the product team – as an organizational anti-pattern
...
marketing materials outside of the application – most of such consequences can
...
above, it does not matter what tool that – good tasks share some common
...
on at any time – be it at the time the task is actively planned or being worked
...
- open communication and direct collaboration among **all** stakeholders – this
