...
two sentiments. One is simply ego. As the virologists and epidemiologists say
...
endeavors might more often than not be questionable.
...
It's a property of the problem you're solving. Adding two numbers is generally a
...
memory management, you have to compile, etc. – all of that isn't necessary for
...
particular problem domain (e.g. routing, data loading, etc.), it takes all of
the accidental complexity associated with these aspects out of the hands of the
...
add value. In contrast to that, building on micro packages and aiming for
...
community pay that cost once, for the entire community to benefit afterward.
...
[exercise of completely over-engineering a static site](https://simplabs.com/blog/2020/01/31/how-to-over-engineer-a-static-page/)
