...
Our Rust expert Luca Palmieri will host a Rust–Python Interoperability workshop, showing how to boost the performance of Python apps by rewriting only the slow parts in Rust. Learn to work with pyo3, navigate the GIL, and build native extensions.
