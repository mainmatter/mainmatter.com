...
bio: "Nick Schot"
description: "Nick Schot explains how to integrate React components in an Ember.JS app."
...
Let’s add the base dependencies for React as well as the [React Vite plugin](https://github.com/vitejs/vite-plugin-react) by running `pnpm add -D react react-dom @vitejs/plugin-react`. With this plugin Vite will know how to build React components. Finally, we'll update the Vite configuration to add the new plugin.
