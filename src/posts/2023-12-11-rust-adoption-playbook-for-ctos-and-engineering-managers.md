...
We'll assume the most common scenario: you have one or two people in your team that have played with Rust in their
...
You've successfully completed your first Rust project: business is thriving, and you need to scale up your team
...
On the other hand, Rust is a very attractive language for developers, so there are a lot of people willing to learn it
if you're willing to train them—they often won't be starting from scratch, having played with Rust in their spare time.
...
at this point in time, but it might be worth doing your research.
...
- [The Rust Programming Language](https://doc.rust-lang.org/book/) (aka "the book"): the official Rust book, 
  and the best place to start. It's a great introduction to the language, and it's kept up to date with the latest
  changes to the language.
- [Programming Rust](https://www.oreilly.com/library/view/programming-rust-2nd/9781492052586/): compared to the Rust
  book, it assumes the reader is a more experienced developer, and it goes into more details about the language
  internals. 
...
[the Rust track Exercism](https://exercism.io/tracks/rust).
