...
shortDescription: "Learn Rust through the familiar lens of web application development. Build a real-world web app while covering ownership, borrowing, concurrency, structs, traits, and data serialization."
