...
shortDescription: "Learn how to migrate real C code to Rust without treating it as a rewrite. Build a practical mental model for FFI boundaries, safe abstractions, testing, and incremental module migration."
