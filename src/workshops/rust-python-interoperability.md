...
shortDescription: "Learn how to replace performance-critical Python modules with Rust extensions. The workshop covers PyO3, maturin, data conversion, the GIL, and Python-facing Rust APIs."
description: >
