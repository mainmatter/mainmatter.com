...
description: >-
  This 1-day workshop teaches attendees everything there is to now about using Rust NIFs in Python, covering tools like maturin and PyO3, the GIL, and advanced topics like creating Python classes from Rust, static methods, and inheritance.
